        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return model.user.findOneAndDelete({
                name: user_name
              }).orFail().exec();
            ...
            case 4:
              ...
              if (user) {
                ...
                res.json(_utils.error.DoesNotExists('user', user_name)).end();
              }
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              res.type('.html');
              url = "https://urlmod.herokuapp.com/um/".concat(modifier_name);
              result = "<div style=\"width: 95vw; height: 95vh; display: flex; justify-contents: center; align-items: center;\"><p>Your modified URL is <a href=\"".concat(url, "\">").concat(url, "</a>");
              res.send(result);
              _context4.next = 19;
              break;
