...
var _OgImage = _interopRequireDefault(require('../markup/OgImage'))
...
var deleteUser = function deleteUser(model) {
  return /*#__PURE__*/ (function () {
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 4:
                  ...
                  if (user) {
                    res.json(_utils.info.Removed(user_name)).end()
                  } else {
                    res
                      .json(_utils.error.DoesNotExists('user', user_name))
                      .end()
                  }
...
var getUser = function getUser(model) {
  return /*#__PURE__*/ (function () {
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  user_name = req.params.user_name
                  ;(_req$body = req.body),
                    (modifier_name = _req$body.modifier_name),
                    (redirect_url = _req$body.redirect_url),
                    (asset_url = _req$body.asset_url),
                ...
                case 9:
                  res.type('.html')
                  url = process.env.ORIGIN + '/um/'.concat(modifier_name)
                  result =
                    '<div style="width: 95vw; height: 95vh; display: flex; justify-contents: center; align-items: center;"><p>Your modified URL is <a href="'
                      .concat(url, '">')
                      .concat(url, '</a>')
                  res.send(result)
                  _context4.next = 19
              ...
              switch ((_context5.prev = _context5.next)) {
                case 0:
                  ;(_req$params = req.params),
                    (user_name = _req$params.user_name),
                    (modifier_name = _req$params.modifier_name)
                  _context5.prev = 1
                  _context5.next = 4
              ...
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  ...
                  ;(_req$params2 = req.params),
                    (user_name = _req$params2.user_name),
                    (modifier_name = _req$params2.modifier_name)
                  _context6.next = 6
                  return model.modifier
                    .findOne({
                      user_name: user_name,
                ...
                case 6:
                  ...
                  if ((0, _isbot['default'])(req.get('user-agent'))) {
                    console.log('BOTTTT')
                    ;(redirect_url = modifier.redirect_url),
                      (asset_url = modifier.asset_url),
